...
/***/ function(module, exports, __webpack_require__) {
	...
	function TodoList(props) {
	    ...
	    return _react2.default.createElement(
	        'div',
	        { className: 'todo' },
	        _react2.default.createElement('input', { type: 'text', className: 'todo__entry', placeholder: 'Add todo', onKeyDown: onSubmit }),
	        _react2.default.createElement(
	            ...
	            todos.map(function (t) {
	                return _react2.default.createElement(
	                    'li',
	                    { key: t.get('id'), className: 'todo__item', onClick: toggleCLick(t.get('id')) },
	                    _react2.default.createElement(_Todo.Todo, { todo: t.toJS() })
	                );
	            })
	        )
	    );
	    ...
	    switch (action.type) {
	        ...
	        case 'TOGGLE_TODO':
	            return todos.map(function (t) {
	                if (t.get('id') === action.payload) return t.update('isDone', function (isDone) {
	                    return !isDone;
	                });else return t;
	            });
	        default:
